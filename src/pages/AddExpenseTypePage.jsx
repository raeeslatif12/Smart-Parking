...
import { addExpenseType } from "../store/expenseTypesSlice";
...
const AddExpenseTypePage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (name.trim()) {
      dispatch(addExpenseType({ name: name.trim() }));
  ...
  return (
    <div className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-[#0f172a]">Add Expense Type</h1>
        </div>
        <div className="bg-white shadow-sm rounded-xl p-8 max-w-md">
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              <label
                htmlFor="expenseTypeName"
