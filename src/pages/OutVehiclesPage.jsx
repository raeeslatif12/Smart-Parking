  ...
  return (
    <div className="py-4 sm:py-6 flex-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Out Vehicles</h1>
          <p className="text-gray-600 mt-2 font-medium">Vehicles that have exited the parking system</p>
        </div>
