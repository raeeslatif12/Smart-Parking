...
import { updateAdmin } from '../store/adminsSlice';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.password) {
        ...
        updatePayload.password = admin.password;
      }

      dispatch(updateAdmin(updatePayload));
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-center">
            ...
            <p className="text-gray-600 mb-6">Only Super Admins can edit admins.</p>
            <button
      ...
      <div className="p-6 bg-gray-100 min-h-screen">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-center">
            ...
            <p className="text-gray-600 mb-6">The admin you are trying to edit does not exist.</p>
            <button
    ...
    <div className="p-6 bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="w-full max-w-2xl">
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">Edit Admin</h1>
